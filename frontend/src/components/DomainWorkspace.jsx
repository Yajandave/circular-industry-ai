...
import DataProfilerPanel from './DataProfilerPanel.jsx';
...
export default function DomainWorkspace({ domain, onBackToCore }) {
  ...
  const isDataProfiler = domain.id === 'data-profiler';
    ...
    <section className="domain-workspace-panel">
          ...
          <div className="domain-upload-zone">
            <div>
              ...
              <p>
                ...
                EIA, claims or supplier datasets into industrial material-flow rules.
              </p>
      ...
      <div className="domain-core-compatibility-note">
        ...
        <p>
          ...
          mapped and eventually confirmed industrial material-flow, waste/resource stream and circular procurement datasets.
        </p>
      </div>
    </section>
  );
